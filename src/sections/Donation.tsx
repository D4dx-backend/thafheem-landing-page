    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          >
            <div className="rounded-2xl border border-[#0d9ba8]/20 bg-white p-6 sm:p-7 shadow-xl">
              <span className="text-xs font-semibold uppercase tracking-widest text-[#0d9ba8]">Direct UPI &amp; Bank</span>
              <h4 className="text-xl font-bold text-[#1a1a2e] mt-2 mb-3">Scan QR or transfer directly</h4>

              <div className="flex justify-center mb-3">
                <div className="bg-white border-2 border-[#0d9ba8]/20 rounded-2xl p-3 shadow-md">
                  <img
              ...
              <p className="text-sm text-[#4a5568] text-center mb-4">Open any UPI app, tap <strong>Scan QR</strong>, and donate</p>

              <div className="w-full flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 mb-3">
              ...
              <div className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 flex flex-col gap-1.5 text-xs text-[#4a5568] mb-3">
              ...
              <div className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 flex flex-col gap-1.5 text-xs text-[#4a5568]">
                <div className="flex justify-between items-center gap-4">
                  <span className="text-[#718096]">Account Name</span>
                  <span className="font-semibold text-[#1a1a2e] text-right">D4DX INNOVATIONS LLP</span>
                </div>
                <div className="h-px bg-gray-200" />
                <div className="flex justify-between items-center gap-4">
                  <span className="text-[#718096]">Account number</span>
                  <span className="font-semibold text-[#1a1a2e] font-mono text-right">50200102639272</span>
                </div>
                <div className="h-px bg-gray-200" />
                <div className="flex justify-between items-center gap-4">
                  <span className="text-[#718096]">IFSC code</span>
                  <span className="font-semibold text-[#1a1a2e] font-mono text-right">HDFC0002811</span>
                </div>
                <div className="h-px bg-gray-200" />
                <div className="flex justify-between items-center gap-4">
                  <span className="text-[#718096]">Branch</span>
                  <span className="font-semibold text-[#1a1a2e] text-right">CIVIL STATION</span>
                </div>
              </div>
            </div>
          </div>
